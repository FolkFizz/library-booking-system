...
🔗 Live Demo: https://library-booking-system-m61q.vercel.app

📄 API Documentation (Swagger): https://library-booking-system.onrender.com/docs
...
Modern UI with TailwindCSS for styling.
...
Serverless cloud database managed via SQLAlchemy ORM.

Deployment

Vercel (FE) + Render (BE)

CI/CD enabled cloud hosting.

Authentication

JWT (JSON Web Tokens)

Secure stateless authentication with bcrypt hashing.
...
A Confirmation Dialog appears (Safety Guard).

Confirming removes the booking instantly from the database and updates the UI.
...
git clone [https://github.com/FolkFizz/library-booking-system.git](https://github.com/FolkFizz/library-booking-system.git)
...
Folk (FolkFizz) Aspiring QA Automation Engineer | Tech Enthusiast